...
public class AdminController {
	...
	@GetMapping("/listoftripsbycustomerId")
	...
	@GetMapping("/lisoftrips")
	public List<CompletedTrips> listOfAllTripsHanlder(@RequestParam String key){
	...
	public List<Customer> listOfCustomersHandler(@RequestParam String key){
		
		return adminService.getListOfCustomers(key);
	...
	public List<Driver> listOfDriversHandler(@RequestParam String key){
		
		return adminService.getListOfDrivers(key);
