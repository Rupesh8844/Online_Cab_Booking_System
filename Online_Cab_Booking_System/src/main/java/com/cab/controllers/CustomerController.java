...
public class CustomerController {
	...
	public Customer updateCustomerByMobileHandler(@RequestBody Customer customer, @PathVariable("mobile") String mobile,
	...
	public List<Driver> listavailableCabsHandler() {
	...
	@GetMapping("/allcabs")
	public List<Driver> listofallCarsHandler() {
	...
	public ResponseEntity<TripBooking> bookTripHandler(@RequestBody TripBooking trip, @RequestParam String key) {
	...
	@GetMapping("/logout")
	public String logoutCustomerHandler(@RequestParam String key) {
	...
	@DeleteMapping("/completedTrip/{tripid}")
	public String completedTripHandler(@RequestParam String key, @PathVariable("tripid") Integer tripId) {
	...
	public String cancelTripHandler(@RequestParam String key, @RequestParam Integer tripId) {
	...
	public ResponseEntity<TripBooking> updateTripHandler(@RequestBody TripBooking trip, @RequestParam String key ){
